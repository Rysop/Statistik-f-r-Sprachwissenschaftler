...
output <- paste ("Bei einer Standardabweichung von ", s, "sind", ausgezeichnet * 100, "% erfolgreich.")
 print(output)
}
...
Allerdings muss man in Betracht ziehen, dass die Anzahl guter Noten hier nur 3 beträgt (13,14,15), während es mehr Möglichkeiten gibt durchzufallen (0,1,2,3,4). Dadurch gibt es vermeitlich mehr schlechte Noten.
...
Um in dem besten 1% abzuschließen, muss man zumindest `qnorm(0.99,mean=mu,sd=3)` Notenpunkte bekommen.
...
Bei diesem Dozenten ist die Verwaltung wirklich unsicher, ob und was für einen Unterschied es geben könnte. 
Am besten einen zweiseitigen Test, da man nicht weiß, in welche Richtung der Unterschied geht.
...
Ist die Benotung vom Dozenten weniger als ideal? Der Unterschied zwischen kritischem Wert und tatsächlichem Wert ist sehr groß, deswegen ist die Benotung nicht ideal.

### Ein anderer, böserer? Dozent
Die Verwaltung ist auch auf einen anderen Dozenten aufmerksam geworden, weil manche Studenten behaupten, er würde zu streng benoten. (Welche Testart sollte man hier nutzen?) Einseitigen Test.
...
Das Werk dient nur zu Prüfungszwecken!
