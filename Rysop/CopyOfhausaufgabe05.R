# Hausaufgabe 04
# Anna Uta Rysop <rysop@students.uni-marburg.de>
# 2014-05-02
...
# Es fehlen Gruppe "Germanistische Linguistik", die auch nur eine Vertreterin der Gruppe hat, sowie die Gruppe "Sonstiges".
