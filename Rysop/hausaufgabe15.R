...
Der Residual standard error ist bei m2 kleiner als bei m (2.926 vs.6.437).
R^2 hat sich nicht geändert (bei beiden 0.044)
...
Der R^2 Wert hat sich nicht verändert, der Residual-Wert ist allerdings viel höher (liegt hier bei 12.75) 
